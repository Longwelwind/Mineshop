...
class PayementRentabiliweb extends PayementType
{
  private $CI;
  private $dataAPI;
 ...
 <table cellpadding="0" cellspacing="0" style="width: 436px;  border: solid 1px #AAAAAA;">
    ...
    <tr height="250">
        <td width="280"  style="background-color: #FFFFFF;">
            <iframe name="rweb_display_frame" width="280" height="250" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" src="http://payment.rentabiliweb.com/form/acte/frame_display.php?docId=<?php echo $this->dataAPI[1]; ?>&siteId=<?php echo $this->dataAPI[1]; ?>&cnIso=geoip&lang=fr&skin=default">
            </iframe>
        </td>
        <td width="156" style="border-left: 1px solid #AAAAAA; background-color: #FFFFFF;">
            <iframe name="rweb_flags_frame" width="156" height="250" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" src="http://payment.rentabiliweb.com/form/acte/frame_flags.php?docId=<?php echo $this->dataAPI[1]; ?>&siteId=<?php echo $this->dataAPI[0]; ?>&lang=fr&skin=default">
            </iframe>
        </td>
    </tr>
    <tr>
        <td colspan="2" style="border-top: 1px solid #AAAAAA; background-color: #F7F7F7;">
            <form id="<?php echo $this->dataAPI[1]; ?>" method="get" action="http://payment.rentabiliweb.com/access.php" style="margin: 0px; padding: 0px;" >
          ...
          <br/>
                 ...
                 <tr>
                  <td style="text-align: center">
                     ...
                     <input type="hidden" name="docId" value="<?php echo $this->dataAPI[1]; ?>" /><input type="button"  alt="Ok" onclick="getElementById('rweb_sub_<?php echo $this->dataAPI[1]; ?>').disabled=true;document.getElementById('rweb_tickets_<?php echo $this->dataAPI[1]; ?>').submit();" id="rweb_sub_<?php echo $this->dataAPI[1]; ?>"  style="width: 40px; height:20px; vertical-align:middle; margin-left: 5px; border: none; background:url(http://payment.rentabiliweb.com/data/i/component/button_okdefault.gif);"/></td>
                 </tr>
                </table>    
            </form>
   ...
   <div style="text-align: center; padding: 2px; font-family: Arial, Helvetica, sans-serif;">
                <a href="javascript:;"  onclick="javascript:window.open('http://payment.rentabiliweb.com/support/?docId=<?php echo $this->dataAPI[1]; ?>&siteId=<?php echo $this->dataAPI[0]; ?>&lang=fr','rentabiliweb_help','toolbar=0,location=0,directories=0,status=0,scrollbars=1,resizable=1,copyhistory=0,menuBar=0,width=995,height=630');" style="color: #3b5998; font-weight:bold; font-size: 12px; text-decoration: none;">Support technique</a><span style="color: #AAAAAA;"> / </span><a href="javascript:;"  onclick="javascript:window.open('http://payment.rentabiliweb.com/support/?docId=<?php echo $this->dataAPI[1]; ?>&siteId=<?php echo $this->dataAPI[0]; ?>&lang=en','rentabiliweb_help','toolbar=0,location=0,directories=0,status=0,scrollbars=1,resizable=1,copyhistory=0,menuBar=0,width=995,height=630');" style="color: #5c5c5c; font-weight:normal; font-size: 12px; text-decoration: none;">Technical support</a>            </div>
        </td>
    </tr>
 </table>
</td></tr></table>
