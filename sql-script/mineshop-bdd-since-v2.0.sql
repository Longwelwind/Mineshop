...
--
-- Structure de la table `shp_config`
--

CREATE TABLE IF NOT EXISTS `shp_config` (
...
INSERT INTO `mineshop`.`shp_offers_categories` (`category_id`, `category_name`, `category_description`) VALUES (NULL, 'Offres par défaut de test', 'Ici vous trouverez des offres de test pour vous aider à configurer vos propres offres. Vous pouvez à tout moment les supprimer dans la partie Administration->Offres');

INSERT INTO `shp_offers` (`offer_id`, `offer_category_id`, `offer_name`, `offer_description`, `offer_price`, `offer_is_unique`, `offer_time_required`, `offer_offer_required`, `offer_can_pay_with_time`, `offer_order`, `offer_deleted`) VALUES(1, 1, 'Pack d''objet', '', 50, 0, 0, 0, 0, 0, 0);
INSERT INTO `shp_offers` (`offer_id`, `offer_category_id`, `offer_name`, `offer_description`, `offer_price`, `offer_is_unique`, `offer_time_required`, `offer_offer_required`, `offer_can_pay_with_time`, `offer_order`, `offer_deleted`) VALUES(2, 1, 'Premier rang Eclaireur', '', 40, 1, 0, 0, 0, 0, 0);
INSERT INTO `shp_offers` (`offer_id`, `offer_category_id`, `offer_name`, `offer_description`, `offer_price`, `offer_is_unique`, `offer_time_required`, `offer_offer_required`, `offer_can_pay_with_time`, `offer_order`, `offer_deleted`) VALUES(3, 1, 'Deuxième rang Chevalier', '', 40, 1, 0, 2, 0, 0, 0);
INSERT INTO `shp_offers` (`offer_id`, `offer_category_id`, `offer_name`, `offer_description`, `offer_price`, `offer_is_unique`, `offer_time_required`, `offer_offer_required`, `offer_can_pay_with_time`, `offer_order`, `offer_deleted`) VALUES(4, 1, 'Troisième rang Roi', '', 40, 1, 0, 3, 0, 0, 0);
INSERT INTO `shp_offers` (`offer_id`, `offer_category_id`, `offer_name`, `offer_description`, `offer_price`, `offer_is_unique`, `offer_time_required`, `offer_offer_required`, `offer_can_pay_with_time`, `offer_order`, `offer_deleted`) VALUES(5, 1, 'Cadeau 1 mois ', '', 0, 1, 2592000, 0, 0, 0, 0);
INSERT INTO `shp_offers` (`offer_id`, `offer_category_id`, `offer_name`, `offer_description`, `offer_price`, `offer_is_unique`, `offer_time_required`, `offer_offer_required`, `offer_can_pay_with_time`, `offer_order`, `offer_deleted`) VALUES(6, 1, 'Cadeau 3 mois', '', 0, 1, 5184000, 0, 0, 0, 0);
